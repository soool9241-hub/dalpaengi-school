...
export const COURSES = {
  ...
  standard: {
    ...
    bonus: "달팽이스쿨 1년 멤버십 자격 (선착순 100명)",
    membershipGrant: "yearly_1year" as const,
  },
  premium: {
    id: "premium",
    name: "빌더 프리미엄",
    ...
    earlybirdPrice: null,
    status: "soldout" as const, // 대기자제
    bonus: "달팽이스쿨 평생 멤버십 자격 (선착순 100명)",
    membershipGrant: "lifetime" as const,
  },
} as const;
...
export const FAQ_ITEMS = [
  ...
  { q: "빌더코스와 달팽이스쿨의 차이가 뭔가요?", a: "빌더코스는 3~24시간 원데이 체험이에요. 달팽이스쿨은 1년간 매달 만나는 멤버십이고요. 빌더 기본/프리미엄 수강자에게는 멤버십 자격이 자동 부여돼요." },
  { q: "온라인으로만 하나요?", a: "현재는 온라인 줌 중심이에요. 전국 어디서든 참여할 수 있어요. 프리미엄(1박2일)은 완주 오프라인으로 진행돼요." },
  { q: "환불 정책이 궁금해요.", a: "빌더코스는 수강일 7일 전까지 100% 환불, 3일 전까지 50% 환불이에요. 자세한 건 카톡 sool9241로 문의주세요." },
  { q: "달팽이스쿨은 언제 오픈하나요?", a: "빌더코스 1~3기를 먼저 운영하면서 구조를 검증한 뒤 오픈할 예정이에요. 대기자 등록하시면 가장 먼저 안내드려요." },
  { q: "왜 빌더코스 하나만 하세요? 다른 프로그램은 없나요?", a: "오직 1개만 먼저 합니다. 검증 안 된 여러 상품보다, 검증된 1개가 훨씬 강력해요. 빌더코스를 여러 기수 운영하면서 다져진 뒤 스쿨·심화 프로그램을 순차 오픈합니다." },
] as const;
